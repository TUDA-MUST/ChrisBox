...
#include <Arduino.h>
#include "Protocentral_ADS1220_mod.h"
#include <SPI.h>
#include <limits.h>
...
Protocentral_ADS1220_mod::Protocentral_ADS1220_mod() 								// Constructors
{

}

void Protocentral_ADS1220_mod::writeRegister(uint8_t address, uint8_t value)
{
...
uint8_t Protocentral_ADS1220_mod::readRegister(uint8_t address)
{
    uint8_t data;
...
void Protocentral_ADS1220_mod::begin(uint8_t cs_pin, uint8_t drdy_pin)
{
    m_drdy_pin=drdy_pin;
    m_cs_pin=cs_pin;
...
void Protocentral_ADS1220_mod::PrintRegisterValues(){
    ...
    Serial.println(Config_Reg0, BIN);
    Serial.println(Config_Reg1, BIN);
    Serial.println(Config_Reg2, BIN);
    Serial.println(Config_Reg3, BIN);
    Serial.println(" ");
}

void Protocentral_ADS1220_mod::SPI_Command(unsigned char data_in)
{
    SPI.beginTransaction(SPI_SETTINGS);
    digitalWrite(m_cs_pin, LOW);
    delayMicroseconds(1);
...
void Protocentral_ADS1220_mod::ads1220_Reset()
{
    SPI_Command(RESET);
}

void Protocentral_ADS1220_mod::Start_Conv()
{
    SPI_Command(START);
}

// control register 0
void Protocentral_ADS1220_mod::select_mux_channels(int channels_conf)
{
...
void Protocentral_ADS1220_mod::set_pga_gain(int pgagain)
{
...
void Protocentral_ADS1220_mod::PGA_ON(void)
{
    m_config_reg0 &= ~_BV(0);
    writeRegister(CONFIG_REG0_ADDRESS,m_config_reg0);
}

void Protocentral_ADS1220_mod::PGA_OFF(void)
{
    m_config_reg0 |= _BV(0);
    writeRegister(CONFIG_REG0_ADDRESS,m_config_reg0);
}
...
// control register 1
void Protocentral_ADS1220_mod::set_data_rate(int datarate)
{
...
void Protocentral_ADS1220_mod::set_OperationMode(int OPmode)
{
...
void Protocentral_ADS1220_mod::set_conv_mode_single_shot(void)
{
    m_config_reg1 &= ~_BV(2);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}

void Protocentral_ADS1220_mod::set_conv_mode_continuous(void)
{
    m_config_reg1 |= _BV(2);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}

void Protocentral_ADS1220_mod::TemperatureSensorMode_disable(void)
{
    m_config_reg1 &= ~_BV(1);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}

void Protocentral_ADS1220_mod::TemperatureSensorMode_enable(void)
{
    m_config_reg1 |= _BV(1);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}

void Protocentral_ADS1220_mod::CurrentSources_OFF(void)
{
    m_config_reg1 &= ~_BV(0);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}

void Protocentral_ADS1220_mod::CurrentSources_ON(void)
{
    m_config_reg1 |= _BV(0);
    writeRegister(CONFIG_REG1_ADDRESS,m_config_reg1);
}
...
// control register 2
void Protocentral_ADS1220_mod::set_VREF(int vref)
{
...
void Protocentral_ADS1220_mod::set_FIR_Filter(int filter)
{
...
void Protocentral_ADS1220_mod::LowSideSwitch_OPEN(void)
{
    m_config_reg2 &= ~_BV(3);
    writeRegister(CONFIG_REG2_ADDRESS,m_config_reg2);
}

void Protocentral_ADS1220_mod::LowSideSwitch_CLOSED(void)
{
    m_config_reg2 |= _BV(3);
    writeRegister(CONFIG_REG2_ADDRESS,m_config_reg2);
}

void Protocentral_ADS1220_mod::set_IDAC_Current(int IDACcurrent)
{
...
// control register 3
void Protocentral_ADS1220_mod::set_IDAC1_Route(int IDAC1routing)
{
...
void Protocentral_ADS1220_mod::set_IDAC2_Route(int IDAC2routing)
{
 ...
 void Protocentral_ADS1220_mod::DRDYmode_default(void)
 {
     m_config_reg3 &= ~_BV(3);
     writeRegister(CONFIG_REG3_ADDRESS,m_config_reg3);
 }

 void Protocentral_ADS1220_mod::DRDYmode_DOUT(void)
 {
     m_config_reg3 |= _BV(3);
     writeRegister(CONFIG_REG3_ADDRESS,m_config_reg3);
 }
...
uint8_t * Protocentral_ADS1220_mod::get_config_reg()
{
...
bool Protocentral_ADS1220_mod::WaitForData(unsigned int timeout_ms){
...
uint8_t * Protocentral_ADS1220_mod::Read_Data(void){
    SPI.beginTransaction(SPI_SETTINGS);
...
int32_t Protocentral_ADS1220_mod::DataToInt(){
    int32_t result = 0;
    result = DataReg[0];
...
int32_t Protocentral_ADS1220_mod::Read_WaitForData()
{
    if(!WaitForData(60)){
        return 0;
    }
...
int32_t Protocentral_ADS1220_mod::Read_Data_Samples()
{
...
int32_t Protocentral_ADS1220_mod::Read_SingleShot_WaitForData(void)
{
    Start_Conv();
    return Read_WaitForData();
}

int32_t Protocentral_ADS1220_mod::Read_SingleShot_SingleEnded_WaitForData(uint8_t channel_no)
{
...
void Protocentral_ADS1220_mod::internal_reference(){
    m_config_reg2 &= ~VREF_MASK;
    m_config_reg2 |= VREF_INT;
    writeRegister(CONFIG_REG2_ADDRESS,m_config_reg2);
}

void Protocentral_ADS1220_mod::external_reference(){
    m_config_reg2 &= ~VREF_MASK;
    m_config_reg2 |= VREF_EXT;
    writeRegister(CONFIG_REG2_ADDRESS,m_config_reg2);
}

void Protocentral_ADS1220_mod::printPins() {
  Serial.print("Pins vom ADC: DRDY = ");
  Serial.print(m_drdy_pin);
  Serial.print(", CS = ");
  Serial.println(m_cs_pin);
}